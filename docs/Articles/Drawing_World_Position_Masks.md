...
Используя в связке с функцией **MF_RVT_MaskedBend** (поставляется с плагином), можно, например, добиться эффекта приминаемой от движения объекты травы, которая сохранит своё примятое состояние, когда объект проедет мимо.
